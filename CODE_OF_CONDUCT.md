<!-- English speakers: this is the French Contributor Covenant v2.1; the canonical
English text lives at https://www.contributor-covenant.org/version/2/1/code_of_conduct/ -->
...
Les cas de comportements abusifs, harcelants ou tout autre comportement inacceptables peuvent être signalés aux dirigeant·e·s de la communauté responsables de l'application du code de conduite à [@KevinGallaccio](https://github.com/KevinGallaccio) (message privé GitHub ou signalement privé du dépôt).
